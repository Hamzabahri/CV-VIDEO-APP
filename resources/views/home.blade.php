...
@section ("content")
    <section class="site-section" style="background-image: url({{Asset('images/imgg.jpg')}});">

            <div class="container">


                @foreach(\App\Offre_demploi::get_offre() as $offre)
...
<div class="row align-items-center">
                <div class="col-12 text-center mt-4 mb-5">
                    <div class="row justify-content-center">
                        <div class="col-md-0">     
<a href="{{route('toutoffre')}}" class="btn btn-block btn-primary btn-md">Voir plus</a>                    
