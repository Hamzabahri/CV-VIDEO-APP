    ...
    <section class="site-section" style="background: #f3eded;">
        <div class="container">
            ...
            <div class="container">
                ...
                @foreach($offresentreprise as $offre)
...
<br>
                                            <a href="{{route('condidatpostuler', ["id_offre" => $offre->id])}}" >

                                                <span class="badge badge-success">{{\App\Postuler::countCondidat($offre->id)}}&nbsp; Condidat</span></a>
