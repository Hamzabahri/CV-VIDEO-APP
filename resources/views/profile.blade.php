        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-6 mb-5" >
                    ...
                    <div class="col-6">
                        <a href="{{route("mesoffres")}}" class="btn btn-block btn-primary btn-md">Mes Offres</a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 mb-5" >
                    ...
                    <form action="{{Route('profile1')}}" method="POST" class="p-4 border rounded" id="registration" name="registration">
                        {{csrf_field()}}
                    ...
                    <div class="row">
                        ...
                        @if ($message = Session::get('success'))
                            ...
                            <h2 class="mb-4">Votre image</h2>
                                <form action="{{ route('upload_image') }}" class="p-4 border rounded" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            @if(isset($user->photo))
                                                <img src="{{asset("images/profile/".$user->photo)}}" class="profile_image">
                                            @endif
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form action="{{ route('changepass') }}" class="p-4 border rounded" method="POST" name="registration1">
                                  {{csrf_field()}}
                ...
                <div class="col-md-12">
                    <form action="{{ route('upload_cv') }}" class="p-4 border rounded" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <input type="file" name="file" class="form-control">
