        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 mb-5" >
                    ...
                    <form action="<?php echo e(Route('deposer')); ?>" method="POST" class="p-4 border rounded" id="registration" name="registration">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <select class="form-control" name="gender">
                                    ...
                                    <option value="M" <?php if($user->civilité == "M"): ?> selected <?php endif; ?>>M</option>
                                    <option value="Mme" <?php if($user->civilité == "Mme"): ?> selected <?php endif; ?>>Mme</option>
                                    <option value="Mlle" <?php if($user->civilité == "Mlle"): ?> selected <?php endif; ?>>Mlle</option>
                                </select>
                        ...
                        <div class="row form-group mb-4">
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <select class="form-control" name="gender1">
                                    ...
                                    <option value="Béja"  <?php if($user->gouvernorat == "Béja"): ?> selected <?php endif; ?>>Béja</option>
                                    ...
                                    <option value="Gabès"  <?php if($user->gouvernorat == "Gabès"): ?> selected <?php endif; ?>>Gabès</option>
                                    ...
                                    <option value="Kébili" <?php if($user->gouvernorat == "Kébili"): ?> selected <?php endif; ?>>Kébili</option>
                                    ...
                                    <option value="Médenine" <?php if($user->gouvernorat == "Médenine"): ?> selected <?php endif; ?>>Médenine</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="<?php echo e(route('upload_cv1')); ?>" class="p-4 border rounded" method="POST" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="row">
                                            <div class="col-md-6">
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cvvidéo\resources\views/deposercv.blade.php ENDPATH**/ ?>