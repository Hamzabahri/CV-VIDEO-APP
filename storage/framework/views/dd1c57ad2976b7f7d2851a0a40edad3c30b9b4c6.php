        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5">
                    ...
                    <form action="<?php echo e(Route('inscri1')); ?>" method="post" class="p-4 border rounded" id="registration" name="registration">
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cvvidéo\resources\views/inscricondidat.blade.php ENDPATH**/ ?>